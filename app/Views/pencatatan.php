                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <div class="button-group">
                                    <a href="<?= base_url('Home/t_pencatatan') ?>">
                                        <button class="btn btn-warning">+ Tambah</button>
                                    </a>
                                    
                                    <!-- Moved functionality to the new "Tes" button -->
                                    <button class="btn btn-info" data-toggle="modal" data-target="#tesModal">Pilih</button>

                                    <?php if($activepage === 'filter_pencatatan_by_status') { ?>
                                    <a href="<?= base_url('Home/pencatatan') ?>" class="btn btn-secondary back-button">Kembali</a>
                                    <?php }?>
                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(session()->get('id_level')==1 || session()->get('id_level')==2) { ?>
                                                    ...
                                                    >Detail</button>
                                                    <a href="<?= base_url('Home/hapus_pencatatan/'.$wkwk->id_pencatatan)?>">
